    ...
    <div className={classes.hero}>
      ...
      <Container className={classes.container}>
        ...
        <Text className={classes.description} size="xl" mt="xl">
            Innovando el reciclaje con tecnología interactiva y educativa. Descubre una forma sencilla y divertida de clasificar tus residuos mientras aprendes sobre la importancia de la sostenibilidad. 
        </Text>
      </Container>
    </div>
  );
